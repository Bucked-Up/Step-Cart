...
const createCart = ({ title, subTitle, bumpTitle, country }) => {
  ...
  return { purchaseButton, closeCartButtons, cartWrapper, cartBackdrop, stepsWrapper, stepsBack, backToSteps, cartQuantity };
};
